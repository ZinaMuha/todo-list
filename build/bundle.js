...
/***/ "./components/ArrowButton/ArrowButton.js":
/*!***********************************************!*\
  !*** ./components/ArrowButton/ArrowButton.js ***!
  \***********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scripts_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../scripts/actions */ \"./scripts/actions.js\");\n/* harmony import */ var _arrow_button_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./arrow-button.scss */ \"./components/ArrowButton/arrow-button.scss\");\n/* harmony import */ var _arrow_button_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_arrow_button_scss__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nvar ArrowButton = function ArrowButton(_ref) {\n  var _ref$isUpDirection = _ref.isUpDirection,\n      isUpDirection = _ref$isUpDirection === void 0 ? false : _ref$isUpDirection,\n      id = _ref.id;\n\n  var _this = document.createElement('button');\n\n  var direction = isUpDirection ? 'up' : 'down';\n\n  _this.setAttribute('name', direction);\n\n  _this.setAttribute('type', 'button');\n\n  _this.classList.add(\"arrow-button\", \"arrow-button_\".concat(direction));\n\n  _this.innerHTML = \"<span class=\\\"arrow-button__icon\\\"></span>\";\n\n  _this.addEventListener('click', function () {\n    var item = document.getElementById(id);\n    var itemsArr = Array.prototype.slice.call(document.querySelectorAll('.task'));\n    var index = itemsArr.indexOf(item);\n    var list = item.closest('.tasks__list');\n\n    if (isUpDirection) {\n      var nextChild = itemsArr[index - 1];\n\n      if (item === list.firstChild) {\n        return;\n      }\n\n      list.insertBefore(item, nextChild);\n    } else {\n      var _nextChild = itemsArr[index + 1];\n      list.insertBefore(item, _nextChild ? _nextChild.nextSibling : null);\n    }\n\n    var items = document.querySelectorAll('.task');\n    saveTasks(items);\n  });\n\n  return _this;\n};\n\nfunction saveTasks(items) {\n  var arr = _scripts_actions__WEBPACK_IMPORTED_MODULE_0__[\"getTasks\"]();\n  var newArr = [];\n  items.forEach(function (element, index) {\n    var item = arr.find(function (item) {\n      return item.id === +element.id;\n    });\n    newArr[index] = item;\n  });\n  _scripts_actions__WEBPACK_IMPORTED_MODULE_0__[\"setTasks\"](newArr);\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (ArrowButton);\n\n//# sourceURL=webpack:///./components/ArrowButton/ArrowButton.js?");

/***/ }),

/***/ "./components/ArrowButton/arrow-button.scss":
/*!**************************************************!*\
  !*** ./components/ArrowButton/arrow-button.scss ***!
  \**************************************************/
/*! no static exports found */
...
eval("// extracted by mini-css-extract-plugin\n\n//# sourceURL=webpack:///./components/ArrowButton/arrow-button.scss?");
